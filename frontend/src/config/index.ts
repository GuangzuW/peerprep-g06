...
if (!import.meta.env.VITE_MATCHING_SERVICE_ENDPOINT) {
...
if (!import.meta.env.VITE_COLLABORATION_SERVICE_ENDPOINT) {
  throw new Error("VITE_COLLABORATION_SERVICE_ENDPOINT environment variable not configured.");
}
...
export const appConfig = defineConfig({
  ...
  collaborationServiceEndpoint: import.meta.env.VITE_COLLABORATION_SERVICE_ENDPOINT,
});
